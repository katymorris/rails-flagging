...
Vagrant.configure(2) do |config|
    ...
    config.vm.provision :shell, path: "./vagrant-setup/node-setup.sh", privileged: false
    config.vm.provision :shell, path: "./vagrant-setup/react-rails-setup.sh", privileged: false
